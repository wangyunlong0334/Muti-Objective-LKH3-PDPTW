...
/* Macro definitions */
#define C_IS_DISTANCE (C == C_EXPLICIT)
#define C_IS_TIME     (C == C_TIME)
...
extern int *CostMatrix_time;        /* Cost matrix */
...
int C_TIME(Node * Na, Node * Nb);
int D_TIME(Node* Na, Node* Nb);
